...
| :---------------- | :-------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------: | ----------------------------------------------------------------------: |
| Entrer    |  Le visiteur rentre dans la zone de détection   |   Une chandelle sur la table s’illumine et une flamme de la même couleur de border que la chandelle apparait a la meme position (x,y) que la chandelle  |  Une note de piano est entendu à l’allumage de la chandelle   |                         Activation du systeme de detection de mouvement |
| Prendre chandelle | L’interacteur dépladé la chandelle devant le projecteur dans l'axe(y) | La flammme se deplacer dans les meme position (x,y) que la chandelle et elle s'eluminer plus fort | Lorsque la flamme apparait un bruit d'etincelle est declenché | L'installation reconnait l'existance de la flamme et passe à la scène 2 |
